...
/**
 * This class tests {@link org.admew.db.entity.HostListItem} database manipulations.
 *
...
public class HostDbTest extends DbTest {
    ...
    public void testDuplicateAllowedHosts() throws InterruptedException {
        insertAllowedHost("admew.org", USER_SOURCE_ID);
        insertAllowedHost("admew.org", EXTERNAL_SOURCE_ID);
        this.hostEntryDao.sync();
    ...
    public void testRedirectionPriority() throws InterruptedException {
        ...
        insertRedirectedHost("admew.org", "1.1.1.1", USER_SOURCE_ID);
        insertRedirectedHost("admew.org", "2.2.2.2", EXTERNAL_SOURCE_ID);
        this.hostEntryDao.sync();
        ...
        HostEntry entry = this.hostEntryDao.getEntry("admew.org");
        assertNotNull(entry);
