...
import org.admew.R;
import org.admew.db.converter.ListTypeConverter;
import org.admew.db.converter.ZonedDateTimeConverter;
import org.admew.db.dao.HostEntryDao;
import org.admew.db.dao.HostListItemDao;
import org.admew.db.dao.HostsSourceDao;
import org.admew.db.entity.HostListItem;
import org.admew.db.entity.HostsSource;
import org.admew.db.entity.HostEntry;
import org.admew.util.AppExecutors;

import static org.admew.db.Migrations.MIGRATION_1_2;
import static org.admew.db.Migrations.MIGRATION_2_3;
import static org.admew.db.Migrations.MIGRATION_3_4;
import static org.admew.db.Migrations.MIGRATION_4_5;
import static org.admew.db.Migrations.MIGRATION_5_6;
import static org.admew.db.Migrations.MIGRATION_6_7;
import static org.admew.db.entity.HostsSource.USER_SOURCE_ID;
import static org.admew.db.entity.HostsSource.USER_SOURCE_URL;
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static void initialize(Context context, AppDatabase database) {
        ...
        source1.setLabel(context.getString(R.string.hosts_admew_source));
        source1.setUrl("https://admew.org/hosts.txt");
