...
import org.admew.model.source.SourceUpdateService;
import org.admew.model.update.ApkUpdateService;
import org.admew.model.update.UpdateStore;

import static org.admew.model.update.UpdateStore.ADAWAY;
...
public class PrefsUpdateFragment extends PreferenceFragmentCompat {
    ...
    private void bindAppChannelPrefAction() {
        Context context = requireContext();
        AdMewApplication application = (AdMewApplication) context.getApplicationContext();
