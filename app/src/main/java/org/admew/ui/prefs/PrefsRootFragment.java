package org.admew.ui.prefs;

import static android.os.Build.VERSION.SDK_INT;
import static android.provider.Settings.ACTION_SECURITY_SETTINGS;
import static android.widget.Toast.LENGTH_SHORT;
import static org.admew.model.root.MountType.READ_ONLY;
import static org.admew.model.root.MountType.READ_WRITE;
import static org.admew.model.root.ShellUtils.isWritable;
import static org.admew.model.root.ShellUtils.remountPartition;
import static org.admew.ui.prefs.PrefsActivity.PREFERENCE_NOT_FOUND;
import static org.admew.util.Constants.ANDROID_SYSTEM_ETC_HOSTS;
import static org.admew.util.Constants.PREFS_NAME;
import static org.admew.util.WebServerUtils.TEST_URL;
import static org.admew.util.WebServerUtils.copyCertificate;
import static org.admew.util.WebServerUtils.getWebServerState;
import static org.admew.util.WebServerUtils.installCertificate;
import static org.admew.util.WebServerUtils.isWebServerRunning;
import static org.admew.util.WebServerUtils.startWebServer;
import static org.admew.util.WebServerUtils.stopWebServer;
...
import org.admew.ui.dialog.MissingAppDialog;
    ...
    private void bindWebServerCertificate() {
        ...
        webServerTest.setOnPreferenceClickListener(preference -> {
            if (SDK_INT < VERSION_CODES.R) {
                ...
                this.prepareCertificateLauncher.launch("admew-webserver-certificate.crt");
            }
            return true;
        });
    }
