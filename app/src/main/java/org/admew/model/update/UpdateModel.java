package org.admew.model.update;
...
import static org.admew.BuildConfig.VERSION_CODE;
import static org.admew.BuildConfig.VERSION_NAME;
import static org.admew.model.update.UpdateStore.getApkStore;
...
public class UpdateModel {
    private static final String MANIFEST_URL = "https://app.admew.org/manifest.json";
    private static final String DOWNLOAD_URL = "https://app.admew.org/admew.apk?versionCode=";
    ...
    private long download(Manifest manifest) {
        ...
        DownloadManager.Request request = new DownloadManager.Request(uri)
                .setTitle("AdMew " + manifest.version)
